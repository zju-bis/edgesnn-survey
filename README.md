...
This repository collects papers on **Spiking Neural Networks (SNNs)** published in influential conferences from 2021 to 2025.  
It serves as the official repository for our survey titled:

> **Edge Intelligence with Spiking Neural Networks**  

The survey systematically reviews SNN works published in top conferences, including **AAAI, ICLR, CVPR, ICCV, IJCAI, MM, ICML, NeurIPS, ECCV**.
...
- [Spiking Attention Mechanism with Transformer Architecture](#spiking-attention-mechanism-with-transformer-architecture)  
...
- [Federated Learning with Spiking Neural Networks](#federated-learning-with-spiking-neural-networks)  
...
<details><summary>Click to expand related papers</summary>
 ...
 - SpGesture: Source-Free Domain-adaptive sEMG-based Gesture Recognition with Jaccard Attentive Spiking Neural Network (NeurIPS'2024)
 - Spike-based Neuromorphic Model for Sound Source Localization (NeurIPS'2024)
 - Spiking Token Mixer: An Event-Driven Friendly Former Structure for Spiking Neural Networks (NeurIPS'2024)
 ...
 - Toward Relative Positional Encoding in Spiking Transformers (NeurIPS'2025)
 - Spiking Meets Attention: Efficient Remote Sensing Image Super-Resolution with Attention Spiking Neural Networks (NeurIPS'2025)
 - Fully Spiking Neural Networks for Unified Frame-Event Object Tracking (NeurIPS'2025)
 - S2M-Former: Spiking Symmetric Mixing Branchformer for Brain Auditory Attention Detection (NeurIPS'2025)
 - A Scalable, Causal, and Energy Efficient Framework for Neural Decoding with Spiking Neural Networks (NeurIPS'2025)
...
<details><summary>Click to expand related papers</summary>
 ...
 - Autonomous Driving with Spiking Neural Networks (NeurIPS'2024)
...
<details><summary>Click to expand related papers</summary>
 ...
 - Learning Optical Flow from Continuous Spike Streams (NeurIPS'2022)
 - Multi-Scale Dynamic Coding Improved Spiking Actor Network for Reinforcement Learning (AAAI'2022)
 ...
 - Unsupervised Optical Flow Estimation with Dynamic Timing Representation for Spike Camera (NeurIPS'2023)
...
<details><summary>Click to expand related papers</summary>
 ...
 - GLIF: A Uniﬁed Gated Leaky Integrate-and-Fire Neuron for Spiking Neural Networks (NeurIPS'2022)
 - LTMD: Learning Improvement of Spiking Neural Networks with Learnable Thresholding Neurons and Moderate Dropout (NeurIPS'2022)
 ...
 - Addressing the speed-accuracy simulation trade-off for adaptive spiking neurons (NeurIPS'2023)
 ...
 - Rethinking the Membrane Dynamics and Optimization Objectives of Spiking Neural Networks (NeurIPS'2024)
...
<details><summary>Click to expand related papers</summary>
 ...
 - EICIL: Joint Excitatory Inhibitory Cycle Iteration Learning for Deep Spiking Neural Networks (NeurIPS'2023)
...
<details><summary>Click to expand related papers</summary>
 ...
 - Toward Robust Spiking Neural Network Against Adversarial Perturbation (NeurIPS'2022)
 ...
 - FEEL-SNN: Robust Spiking Neural Networks with Frequency Encoding and Evolutionary Leak Factor (NeurIPS'2024)
